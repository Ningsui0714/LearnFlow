      ...
      {checkpointTask && (
        <div className="flex shrink-0 flex-col gap-2 border-b border-emerald-100 bg-emerald-50/60 px-4 py-2.5 sm:flex-row sm:items-center sm:px-6" data-testid="checkpoint-learning-task-bar">
          ...
          <div className="flex shrink-0 flex-wrap gap-2">
            ...
            <button type="button" onClick={() => navigate(checkpointTask.management_navigation.path)} className="rounded-lg border border-emerald-200 bg-white px-3 py-2 text-xs font-semibold text-emerald-900 hover:bg-emerald-50">在任务队列中管理</button>
          </div>
        </div>
      )}
